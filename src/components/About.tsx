...
const cards = [
  {
    ...
    description:
      'ייצוג קודם של המוסדות הרפואיים, הרופאים, חברות הביטוח והופעה בבתי משפט בכל רחבי הארץ, מעניק לנו יתרון משמעותי בניהול התיק',
    icon: ScaleIcon,
  },
  {
    title: 'רשת מומחים',
  ...
  },
  {
    ...
    description:
      'משרדנו שם דגש על ליווי אישי, קשוב ומותאם לצרכים הייחודיים של כל לקוח. אנו מתחייבים ליחס אישי, אנושי ומסור ללקוחות מכל רחבי הארץ',
    icon: HeartIcon,
  },
  {
  ...
  },
  {
    title: 'מימון',
    description:
      'למשרדנו שיתוף פעולה פורה עם חברות מימון משפטיות במקרים של העדר יכולת כלכלית לשאת בעלות חוות הדעת הרפואיות או בהוצאות משפט אחרות הדרושות לניהול ההליך',
