                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-16">
                        ...
                        <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">יכולת מוכחת בפיצוח תיקים מורכבים והבנת הליבה הרפואית והמשפטית של כל מקרה ומקרה</p>
                        </div>
                        <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">{'תשלום דמי שכר הטרחה בסוף ההליך ומהצלחה בלבד. ללא תשלום שכ"ט מראש או דמי פתיחת תיק'}</p>
                        </div>
                        <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow duration-300">
